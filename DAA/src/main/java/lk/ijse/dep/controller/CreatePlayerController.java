...
public class CreatePlayerController {
    ...
    public JFXButton btnScorecard;   // ✅ NEW BUTTON
    ...
    public void btnPlayOnAction(ActionEvent actionEvent) throws IOException {
        ...
        if (name.isBlank()){
            new DEPAlert(Alert.AlertType.ERROR,
                    "Error",
                    "Empty Name",
                    "Name can't be empty").show();
            txtName.requestFocus();
            txtName.selectAll();
            return;

        } else if (!name.matches("[A-Za-z ]+")){
            new DEPAlert(Alert.AlertType.WARNING,
                    "Error",
                    "Invalid Name",
                    "Please enter a valid name").show();
            txtName.requestFocus();
            txtName.selectAll();
            return;
        }
        ...
        FXMLLoader fxmlLoader =
                new FXMLLoader(getClass().getResource("/view/Board.fxml"));
